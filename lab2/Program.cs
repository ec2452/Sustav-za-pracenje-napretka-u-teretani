...
using Sustavzapracenjenapretkauteretani.Repositories;
...
var treninzi = new List<Trening> { anaTrening, markoTrening, ivanTrening };

// ==== 4. KORISNICI - 3 korisnika s različitim ciljevima i mjerenjima ====
...
var korisnici = new List<Korisnik> { ana, marko, ivan };

// Povezivanje korisnika s treninzima
anaTrening.Korisnik = ana;
markoTrening.Korisnik = marko;
ivanTrening.Korisnik = ivan;

ana.Treninzi.Add(anaTrening);
marko.Treninzi.Add(markoTrening);
ivan.Treninzi.Add(ivanTrening);
...
builder.Services.AddSingleton<VjezbaRepository>();
builder.Services.AddSingleton<PlanRepository>();
builder.Services.AddSingleton<KorisnikRepository>();
builder.Services.AddSingleton<TreningRepository>();
builder.Services.AddSingleton<TreningVjezbaRepository>();
builder.Services.AddSingleton<CiljRepository>();
builder.Services.AddSingleton<MjerenjeRepository>();
